...
const InputDetails: React.FC = () => {
  ...
  const [input, setInput] = useState<IWInput>(state)
            ...
            <div className="w-full">
              ...
              <span className="w-full grid grid-cols-2  gap-1 md:gap-3   whitespace-nowrap capitalize justify-between items-center">
                <p className="flex flex-col w-full">
                  ...
                  <span>{(input?.warehouse as IWarehouse)?.name}</span>
                </p>
                <p className="flex flex-col w-full">
                  <span className="text-gray-600 uppercase text-xs md:text-sm lg:text-base font-bold tracking-wide">
                    Total:
                ...
                <p className="flex flex-col w-full">
                  ...
                  {(input?.quantity ?? 0).toLocaleString("en-NG")}
                </p>
                <p className="flex flex-col w-full">
                  <span className="text-gray-600 uppercase text-xs md:text-sm lg:text-base font-bold tracking-wide">
                    Disburesed:
                  </span>
                  {Number(input?.quantity_out ?? 0).toLocaleString("en-NG")}
                </p>
              </span>
            </div>
          </div>
