...
const FarmerTable = () => {
  ...
  const verified = useMemo(() => location.pathname.includes("/verified"), [
    location,
  ])
  const unverified = useMemo(() => location.pathname.includes("/unverified"), [
    location,
  ])
  const unsync = useMemo(() => location.pathname.includes("/unsync"), [
    location,
  ])
