...
const TransactionStorageTable = () => {
  ...
  const {data, error, loading, message} = useFetch(`/transaction?type=Storage`)
  ...
  useEffect(() => {
    return () => {
      fetchData("/transaction?type=Storage")
        .then((res) => {
...
export default TransactionStorageTable
