      ...
      <QueryResult
        ...
        emptyResult={
          <EmptyResult
            item="Disbursement"
            image={AddUser}
            path="/dashboard/disbursement/loan"
          />
        }>
                ...
                {currentItems?.map((disbursement, key) => (
                  <tr key={key} className={`divide-y even:bg-[#FAFAFA]`}>
                    ...
                    <td className="p-3 text-[14px] lg:text-[17px]">
                      {
                        (
                          (disbursement.farmer as IFarmer)
