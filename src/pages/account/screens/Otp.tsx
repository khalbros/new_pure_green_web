...
import { farmerVerifyOTP } from "../../../store/actions/farmer_auth.action"
import { getFarmer } from "../../../utils"

const FarmerVerifyOtpPage = () => {
  ...
  function handleSubmit() {
    return dispatch(farmerVerifyOTP(otp.join(""), () => navigate("/account")))
  }
      ...
      <form className="flex flex-col w-full gap-y-4 items-center justify-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <h5 className="flex text-2xl text-green-800 font-sans font-semibold m-5">
            Sorry we need to cornfirm you are the one
          </h5>
          <p className="flex flex-wrap text-gray-600 text-sm text-center gap-1">
            We sent a code to registered number{" "}
            <span className="text-black font-bold">{getFarmer()}</span>
          </p>
        </div>
        {/*  */}
...
export default FarmerVerifyOtpPage
